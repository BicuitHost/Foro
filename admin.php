...
<body>
	<div class="menu">
		<a href="admin.php" class="textMenu"><header>Bicuit Pagina Administrador</header></a>
		<div class="links">
			<a href="cerrarSesion.php" class="linkMenuAdmin">Cerrar Sesión</a>
			<a href="mantenedorUsuarios.php" class="linkMenuAdmin">Administrar Usuarios</a>
